...
const Projects = () => {
  ...
  return (
    <section className="bg-slate-900 text-white pt-40 py-16 px-4" id="projects">
...
//     live: 'https://giaic-figma-hackathon.vercel.app/',
//     code: 'https://github.com/Asia-parveen/giaic-figma-hackathon',
//     tech: ['Next.js', 'Tailwind CSS','SanityCMS'],
//   },
...
// const Projects = () => {
//   return (
//     <section className="bg-slate-900 pt-40 text-white py-16 px-4" id="projects">
//       <div className="max-w-7xl mx-auto">
...
//                     src={project.image}
//                     alt={project.title}
//                     width={360}       // apni zarurat ke mutabiq change kar sakte hain
//                     height={170}
//                     style={{ objectFit: 'cover', borderRadius: '0.75rem 0.75rem 0 0' }}
//                     className="group-hover:scale-110 transition-transform duration-500"
//                     priority={idx < 3}
